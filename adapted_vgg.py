"""
VGG generation mostly copied and slightly adapted from the torchvision.modesl module to work with CIFAR10 images
Can be found under https://github.com/pytorch/vision
This code has originally been licensed under the
